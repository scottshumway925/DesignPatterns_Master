...
void Floater::draw()
{
   if (!isDead())
   {
      vector<string> command = { "FLOATER", to_string(pt.getX()), to_string(pt.getY()), to_string(radius) };
      drawIt(command);
   }
}
...
void Crazy::draw()
{
   if (!isDead())
   {
      vector<string> command = { "CRAZY", to_string(pt.getX()), to_string(pt.getY()), to_string(radius) };
      drawIt(command);
   }
}
...
void Sinker::draw()
{
   if (!isDead())
   {
      vector<string> command = { "SINKER", to_string(pt.getX()), to_string(pt.getY()), to_string(radius) };
      drawIt(command);
   }
}
